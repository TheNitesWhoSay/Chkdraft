...
namespace WinLib {
    ...
    class ButtonControl : public WindowControl
    {
        public:
            ...
            bool CreateThis(HWND hParent, s32 x, s32 y, s32 width, s32 height, const std::string & initText, u64 id, bool imageButton = false, bool clientEdge = true); // Attempts to create a button
