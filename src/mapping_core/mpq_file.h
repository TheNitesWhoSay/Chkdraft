...
public:
    ...
    // Attempts to get the listfile from the MPQ
    // Cannot be used unless the MPQ is already open
...
inline std::ostream & operator<<(std::ostream & os, const AssetAction & assetAction)
{
    switch ( assetAction )
    {
        case AssetAction::Add: os << "Add"; break;
        case AssetAction::Remove: os << "Remove"; break;
    }
    return os;
}

inline std::ostream & operator<<(std::ostream & os, const WavQuality & wavQuality)
{
    switch ( wavQuality )
    {
        case WavQuality::Uncompressed: os << "Uncompressed"; break;
        case WavQuality::High: os << "High"; break;
        case WavQuality::Med: os << "Med"; break;
        case WavQuality::Low: os << "Low"; break;
    }
    return os;
}
