...
class TrigActionsWindow : public WinLib::ClassWindow, public ICndActGridUser
{
    ...
    private:
        ...
        void ChangeActionType(std::size_t triggerIndex, std::size_t actionIndex, Chk::Action::Type newType);
        bool TransformAction(std::size_t triggerIndex, std::size_t actionIndex, Chk::Action::Type newType, bool refreshImmediately);
