...
const std::vector<u32> onOffMenuItems =
{
    ...
    ID_TRIGGERS_TRIGGEREDITOR, ID_TRIGGERS_MISSIONBRIEFINGEDITOR, ID_TOOLS_PASSWORD, ID_SCRIPTS_REPAIRSOUNDS, ID_SCRIPTS_REPAIRSTRINGS_MIN, ID_SCRIPTS_REPAIRSTRINGS_MAX, ID_SCRIPTS_DOWNGRADEFROMREMASTERED,
