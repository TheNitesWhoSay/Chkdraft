...
class Graphics
{
    ...
    private:
		...
		ImageNode* imageEmptyNode = NULL; // First empty slot index -- New entities use this slot (Though keeping empty slots may not be totally necessary)
		SpriteNode* spriteEmptyNode = NULL;
		UnitNode* unitEmptyNode = NULL;
		ImageNode* imageLastCreated = NULL; // Index of the last created entity -- New entities added after this
		SpriteNode* spriteLastCreated = NULL;
		UnitNode* unitLastCreated = NULL;
