...
Everything in mapping core except SFMPQ, FileIO, and MapFile are C++ standard (with minimal reservations like the #define macro). If you're not programming for a windows based operating system or something with a windows port these files will not be usable and alternative MPQ handling will be required.